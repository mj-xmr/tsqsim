...
#ifndef EVALUATIONEXCEPTION_H_INCLUDED
#define EVALUATIONEXCEPTION_H_INCLUDED
 ...
 */
class DLLINTERFACE EvaluationException : public std::runtime_error
{
  public:
  /**
 * Constructor
...
#endif // EVALUATIONEXCEPTION_H_INCLUDED
