...
#ifndef HEDGESOMEWHAT_H_INCLUDED
#define HEDGESOMEWHAT_H_INCLUDED

#include "globals.hpp"
#include "Hedge.hpp"

class DLLINTERFACE HedgeSomewhat : public Hedge
{
  public:
  std::string getName();
/**
 ...
 */
  double hedgeIt(double value);
};


#endif // HEDGESOMEWHAT_H_INCLUDED
